...
- [ ] Matching `dev-docs/todo.md` entry **deleted** (not checked off) in this PR — or, if the entry spans several PRs and this is not the last, its body refreshed so nothing it still poses is already answered (or N/A)
