...
- **Broad scientific knowledge:** scientific skills from the default catalogue (`K-Dense-AI/scientific-agent-skills` unless `KADY_SKILLS_REPO` overrides it), 326 guided workflows across 22 disciplines, and guidance for 229 scientific and financial data resources support fields including genomics, chemistry, drug discovery, materials science, clinical research, earth science, and finance.
