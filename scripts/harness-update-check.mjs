...
if (updates.length === 0) {
  fs.writeFileSync(
    markdownOut,
    `<!-- harness-update signature: none -->\nAll pinned harness packages are current as of ${new Date().toISOString().slice(0, 10)}.\n`,
  );
...
> The three \`@earendil-works/*\` packages share one version line and must be bumped together.
